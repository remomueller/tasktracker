...
* Bug Fix
  ...
  * Frames now correctly retain the dropdown arrow when switching by selecting a new board from the dropdown
...
* Enhancements
  ...
  * Frames are now ordered by end date descending by default on boards index
